...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { image: @gallery.image, model_id: @gallery.model_id, status: @gallery.status } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { image: @gallery.image, model_id: @gallery.model_id, status: @gallery.status } }
