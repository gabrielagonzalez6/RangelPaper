...
class SocialNetworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create social_network" do
    assert_difference('SocialNetwork.count') do
      post social_networks_url, params: { social_network: { name: @social_network.name, profile_id: @social_network.profile_id, type: @social_network.type } }
    end
  ...
  test "should update social_network" do
    patch social_network_url(@social_network), params: { social_network: { name: @social_network.name, profile_id: @social_network.profile_id, type: @social_network.type } }
